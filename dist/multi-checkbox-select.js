...
(function () {
        ...
        function($scope, $element, $timeout, $filter, RepeatParser, uiSelectMinErr, uiCheckboxSelectConfig, $parse, $injector, textService) {
          ...
          ctrl.activate = function(initSearchValue, avoidReset) {
            ...
            if (!ctrl.disabled  && !ctrl.open) {
              ...
              $scope.$broadcast('uiscb:activate');
  ...
  uiscb.directive('uiCheckboxSelectMultiple', ['uiSelectMinErr','$timeout','textService', function(uiSelectMinErr, $timeout, textService) {
    return {
      restrict: 'EA',
      require: ['^uiCheckboxSelect', '^ngModel'],
  ...
  uiscb.directive('uiCheckboxSelectSingle', ['$timeout','$compile', function($timeout, $compile) {
    return {
      ...
      link: function(scope, element, attrs, ctrls) {
        ...
        scope.$on('uiscb:close', function (event, skipFocusser) {
          $timeout(function(){
